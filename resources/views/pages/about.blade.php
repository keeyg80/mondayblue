...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-xl-8 d-flex justify-content-left text-left mt-5">
                    <div class="row ">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum dolore maiores adipisci cum
                            quidem. Corrupti error impedit, quo pariatur hic in excepturi, enim voluptate commodi eligendi
                            doloremque animi dolores libero?</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <h2 style="font-size: 28px; line-height: 40px;">Our Story</h2>
    ...
    <div class="container">
        <div class="row">
            <h2 style="font-size: 28px; line-height: 40px;">Our Values</h2>
            <p style="font-size: 18px; line-height: 30px;" class="sub-heading"></p>
        </div>
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <h2 style="font-size: 28px; line-height: 40px;">Our Team</h2>
            <p style="font-size: 18px; line-height: 30px;" class="sub-heading"></p>
        </div>
        <div class="row">
